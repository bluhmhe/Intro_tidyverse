...
## Spatial packages
#install.packages(c("rgdal", "sp", "sf", "raster", "rnaturalearth", "cowplot", "magick"))
library(rgdal)
library(sp)
library(sf)
library(raster)
...
#set directory where temporary files are saved
write("TMPDIR = _tmp", file=file.path(Sys.getenv('R_USER'), '.Renviron'))
